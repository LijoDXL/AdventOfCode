...
```python
n_fuel = 82892753
elmnts,elmnts_units,oreUnits,equation,chem_units,fuel_eqn = parse_eq(file_name,n_fuel=n_fuel)
full_exp_eqn,extras_ = expand_full(fuel_eqn,equation,chem_units,elmnts,extras={})
tot_ore = ore(full_exp_eqn,elmnts,elmnts_units,oreUnits)
print(tot_ore)
print(1e12 - tot_ore)
```
